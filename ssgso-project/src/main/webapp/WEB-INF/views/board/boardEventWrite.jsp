...
.updatearea textarea{
	width: 98%; 
	margin: 2px 10px 0 10px;}
#addButton { width: 100px; float: right; border: none; height: 30px; background: #6a60a9; color: #fff; margin: 10px 20px 0 0;}
</style>
</head>
<body>
  ...
  <div class="site-wrap">
    ...
    <section>
		<div id="content">
			<form action="insertBoardEvent" method="post">
				<table class="list">
					<tr>
						<th>제목</th>
						<td class="updatearea"><input type="text" name="etitle"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td class="updatearea"><textarea rows="8" cols="60" name="econtent"></textarea></td>
					</tr>
				</table>
